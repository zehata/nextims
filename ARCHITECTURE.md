...
What I currently need to investigate:
 ...
 - ~~Statically generated documentation site, with ability to pull in API definitions from the backend codebase to generate code samples~~
    ...
    - While this will be good to do, I think it will be more prudent to leave this as a continuous improvement target, rather than part of an MVP
 - WIP
...
|------------------------------------------------------------------------|------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------|
| Login via OAuth as data owner                                          | Login as admin                           | Login via data user                                                                                                                |
| Subscribe to data                                                      | Subscribe to data                        | Subscribe to data                                                                                                                  |
| Receive a sample dataset                                               |                                          |                                                                                                                                    |
| Remove [PHIs](https://ohdsi.github.io/CommonDataModel/cdmPrivacy.html) |                                          |                                                                                                                                    |
| Ingress and convert to OMOP schema                                     |                                          |                                                                                                                                    |
| Write into database                                                    |                                          |                                                                                                                                    |
| Ingressed data is displayed                                            | Ingressed data is displayed              | Ingressed data that they have access to is displayed<br><br> Ingressed data they don't have access to is queried, accessed or sent |
